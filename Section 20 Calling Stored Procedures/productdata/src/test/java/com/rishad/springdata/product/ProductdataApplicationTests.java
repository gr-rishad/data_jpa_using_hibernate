...
class ProductdataApplicationTests {
    ...
    public void testAllProducts() {
        productRepository.findAllProducts().stream().forEach(product -> System.out.println(product));
    }

    @Test
    public void testAllProductsByPrice() {
        productRepository.findAllProductsByPrice(800).stream().forEach(product -> System.out.println(product));
    }

    @Test
    public void testAllProductsCountByPrice() {
        int totalProduct = productRepository.findAllProductsCountByPrice(800);
